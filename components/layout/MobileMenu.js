...
export default function MobileMenu({ isMobileMenu, handleMobileMenu }) {
    ...
    return (
        <>
            <div className="mobile-header mobile-header-4 d-block d-lg-none homepagesmall" style={{ backgroundColor: '#A0BFBE' }}>
            ...
            <div className={`mobile-sidebar ${isMobileMenu ? "mobile-menu-active" : ""}`} style={{ backgroundColor: '#A0BFBE' }}>
                ...
                <div className="mobile-nav">
                    <ul className="mobile-nav-list">
                        ...
                        <li className="has-sub hash-has-sub">
                            <Link href="/products" className="font-ks font-16 weight-500 color">Products</Link>
                        </li>
                        <li className="has-sub hash-has-sub">
                            <span className={isActive.key == 1 ? "submenu-button submenu-opened" : "submenu-button"} onClick={() => handleToggle(1)}><em /></span>
                            <Link href="#" className="font-ks font-16 weight-500 color">Markets</Link>
                        ...
                        <li className="has-sub hash-has-sub">
                            <Link href="/contact1" className="font-ks font-16 weight-500 color">Contact</Link>
                        </li>
                        <li className="has-sub hash-has-sub">
                            <Link href="/clients" className="font-ks font-16 weight-500 color">Partners</Link>
                        </li>
                    </ul>
                    <div className="allmobilesection">
                        <Link href="/contact1" className="font-ks font-18 lineh-18 weight-700 color mobilemenubtn">Get Started</Link>
                            ...
                            <div className="footer4-contact-info">
                                <div className="contact-info-single">
                                    ...
                                    <div className="contact-info-text">
                                        <Link href="/tel:+33764855442" className="font-ks font-16 lineh-26 weight-500 color-21">+33 7 64 85 54 42</Link>
                                    </div>
                                </div>
                                <div className="contact-info-single">
                                    <div className="contact-info-icon">
                                    ...
                                    <div className="contact-info-text">
                                        <Link href="/mailto:contact@carocosmo.fr" className="font-ks font-16 lineh-26 weight-500 color-21">contact@carocosmo.fr</Link>
                                    </div>
                                </div>
                                <div className="single-footer single-footer-menu single-footer4">
                                    ...
                                    <div className="contact-info-single">
                                        ...
                                        <div className="contact-info-text">
                                            <Link href="#" className="font-ks font-16 lineh-26 weight-500 color-21">16 rue du cochet <br /> France 78480</Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="single-footer single-footer-menu single-footer4">
